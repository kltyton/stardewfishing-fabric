...
public class MinigameModifiersReloadListener extends SimplePreparableReloadListener<Map<String, JsonObject>> implements MinigameModifiersSupplier, IdentifiableResourceReloadListener {
