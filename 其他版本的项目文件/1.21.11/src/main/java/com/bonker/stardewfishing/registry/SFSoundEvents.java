...
/** Sound event registrations backed by assets/stardew_fishing/sounds.json. */
public final class SFSoundEvents {
    ...
    private static SoundEvent registerSound(String name) {
        return Registry.register(Registries.SOUND_EVENT, StardewFishing.identifier(name),
                SoundEvent.of(StardewFishing.identifier(name)));
    }
}
