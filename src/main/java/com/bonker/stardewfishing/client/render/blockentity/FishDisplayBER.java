package com.bonker.stardewfishing.client.render.blockentity;
...
public class FishDisplayBER implements BlockEntityRenderer<FishDisplayBlockEntity> {
    ...
    @Override
    public void render(FishDisplayBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        if (hitResult != null && hitResult.getType() == HitResult.Type.BLOCK) {
            if (((BlockHitResult) hitResult).getBlockPos().equals(pos)) {
                ...
                if (legendary) {
                    component.withStyle(Style.EMPTY.withColor(SFItems.LEGENDARY_FISH_COLOR));
                }
        ...
        itemRenderer.renderStatic(stack, ItemDisplayContext.FIXED, pPackedLight, pPackedOverlay,
