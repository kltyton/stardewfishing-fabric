...
public final class SFSoundEvents {
    ...
    public static final SoundEvent DWOP_LOUD = register("dwop_loud");
    public static final SoundEvent DWOP_REVERSE_LOUD = register("dwop_reverse_loud");
    ...
    public static SoundEvent getDwop(boolean normal) {
        if (SFConfig.isolateAudioCues()) return normal ? DWOP_LOUD : DWOP_REVERSE_LOUD;
        return normal ? DWOP : DWOP_REVERSE;
    }

    private static SoundEvent register(String name) {
        return Registry.register(BuiltInRegistries.SOUND_EVENT, StardewFishing.resource(name),
